...
## Install basic packages and tools and OpenFoam Executables
...
Run the motoBike case from the tutorial with 500 iterations. The number of timesteps can be defined in the file controlDict under the systems folder. By default the mesh will be setup for a parallel run with with 6 cores. For different core counts one has to modify the system/decomposeParDict.x file. In the Allrun file line 6 has to replaced by pointing to this file.
